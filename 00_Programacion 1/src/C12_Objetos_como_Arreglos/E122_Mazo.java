...
class E122_Mazo extends E11_1_Carta {
    ...
    public static void ImprimirMazo(E122_Mazo mazo) {
        ...
        for (E11_1_Carta carta : mazo.getE121_Mazo()) {
            System.out.println("ubicacion : " + i + " Carta: " + carta.valor + " de " + palos[carta.palo]);
            i++;
        }

    }

    public static int compareTomazo(E11_1_Carta c1, E11_1_Carta c2) {// Return -1 == c1>c2
    ...
    public static int buscarBinario(E122_Mazo mazo, E11_1_Carta carta, int desde, int asta) {
        if (desde == asta || desde < 0 || desde > mazo.getE121_Mazo().length)
            return -1;
        switch (compareTomazo(mazo.getE121_Mazo(desde), carta)) {
            case 0:
                return desde;
            case 1:
                return buscarBinario(mazo, carta, desde + 1, asta);
            case -1:
                return buscarBinario(mazo, carta, desde - 1, desde);
        }
        return -1;
    }
