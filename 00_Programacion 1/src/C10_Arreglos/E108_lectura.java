...
public class E108_lectura {
	...
	public static void main(String[] args) {
		...
		//a. �Cu�l es la salida del siguiente programa?
		//b. Dibuj� un diagrama de pila que muestre el estado del programa justo antes
		//de la sentencia return de mus.
		//c. Describ� en pocas palabras lo que hace mus.
	}
