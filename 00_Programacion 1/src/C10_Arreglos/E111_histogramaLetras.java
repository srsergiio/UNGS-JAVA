...
////	Escrib� un m�todo llamado histogramaLetras que tome una String como par�metro y 
//	devuelva un histograma de las letras del String. El cero-�simo elemento
////	del histograma deber contener la cantidad de a�s en la String (may�sculas y min�sculas); 
//	el 25to elemento debe contener la cantidad de z�s. Tu soluci�n debe
