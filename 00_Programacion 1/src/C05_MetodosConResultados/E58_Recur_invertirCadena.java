...
public class E58_Recur_invertirCadena {
	...
	public static char primero (String s) {// primero: devuelve el primer car�cter de la cadena dada
		return s.charAt (0);
	}
	
	
	public static String resto (String s) {// �ltimo: devuelve una nueva cadena que contiene todas// las letras de la cadena dada, salvo la primera
